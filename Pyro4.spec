...
Version  : 4.78
Release  : 12
URL      : https://files.pythonhosted.org/packages/25/ac/cc83059cd897b7dea44186a76b114ab0dbfe69d69bc10ea4d1029dcb2a6c/Pyro4-4.78.tar.gz
Source0  : https://files.pythonhosted.org/packages/25/ac/cc83059cd897b7dea44186a76b114ab0dbfe69d69bc10ea4d1029dcb2a6c/Pyro4-4.78.tar.gz
...
%prep
%setup -q -n Pyro4-4.78
cd %{_builddir}/Pyro4-4.78
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580748676
...
cp %{_builddir}/Pyro4-4.78/LICENSE %{buildroot}/usr/share/package-licenses/Pyro4/28687233f8a681dc4d5979e85b98d6231a800839
cp %{_builddir}/Pyro4-4.78/docs/source/license.rst %{buildroot}/usr/share/package-licenses/Pyro4/d4c0c8299052f2e2089f956acbbb99f2a6ea77c1
